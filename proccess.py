    ...
    messages_1 = [
        {
            ...
            "text": """
                ...
                Требования к полю «количество комнат»:
                1) Если сдаётся КВАРТИРА:
                    - 1 комната → пиши: 1-комнатная квартира
                    - 2 комнаты → пиши: 2-комнатная квартира
                    - 3 комнаты → пиши: 3-комнатная квартира
                    - 4 комнаты → пиши: 4-комнатная квартира
                    - 5 комнат → пиши: 5-комнатная квартира
                    - «студия» → пиши: квартира-студия
                2) Если сдаётся КОМНАТА в квартире:
                    - если известно общее число комнат → «КОМНАТА в двухкомнатной квартире», «комната в трёхкомнатной квартире» и т.п.
                    - если общее число комнат неизвестно → «КОМНАТА в квартире»
                3) Если тип невозможно однозначно определить, выбери наиболее вероятный вариант по контексту объявления.
                Пример:
                Вход: «Сдам 1-к кв. у м. Отрадное…»
                Выход: «🏠 1-комнатная квартира»
                Требование к полю <площадь квартиры*>: если площадь не указана, то пиши <не указано>
    ...
    messages_1 = [
        {
            ...
            "text": """
                ...
                - Есть контакт (телефон или упоминание Telegram‑ссылки, или ссылка на cian).
                ...
                **Инструкция**:  
                ...
                – Если в тексте несколько квартир — ответьте ровно `Нет`. 
                """,
        },
        {
            "role": "user",
